...
import testimoniesImage from '../../assets/Biz/images/img-testimonies.png';

import Slider from 'react-slick';
import "slick-carousel/slick/slick.css"; 
import "slick-carousel/slick/slick-theme.css";

import '../../assets/Biz/styles/TechnicalHome.css';
            ...
            <Container className="landing-container my-3">
                <div className="flex-row">
                    ...
                    <div className="flex-col image-col">
                        <Image src={testimoniesImage} className='image-size-three' rounded alt="BizSolutions LLC Testimonies from Previous Projects" />
                    </div>
                </div>
