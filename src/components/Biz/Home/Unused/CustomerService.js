...
import customerSupportImage from '../../assets/images/img-customer-support-stock.png';
    ...
    return (
        <>
            <Container className="landing-container my-3 d-none d-lg-block">
                <div className="flex-row">
                    <div className="flex-col content-col mx-3">
                        <h1 className='title text-center biz-color'><Link to="/customer-support-services" style={{ textDecoration: 'none', color: 'inherit' }}>Customer Service Support</Link></h1>
                    ...
                    <div className="flex-col image-col">
                        <Image src={customerSupportImage} className='image-size-two' rounded alt="BizSolutions LLC Home Customer Service Image" />
                    </div>
                </div>
            </Container>
            ...
            <Container className="landing-container d-lg-none">
                <div className="flex-row">
                    <div className="flex-col content-col mx-3">
                        <h1 className='title text-center'><Link to="/customer-support-services" style={{ textDecoration: 'none', color: 'inherit' }}>Customer Service Support</Link></h1>
