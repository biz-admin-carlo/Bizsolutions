...
import webDevelopmentImage from '../../assets/Biz/images/img-web-development-stock.svg';
    ...
    return (
        <>
            <Container className="landing-container my-3 d-none d-lg-block">
                <div className="flex-row">
                    <div className="flex-col image-col">
                        <Image src={webDevelopmentImage} className='image-size' rounded alt="BizSolutions LLC Home Web Development Image" />
                    </div>
                    <div className="flex-col content-col">
                        <h1 className='title text-center biz-color'><Link to="/website-development-solutions" style={{ textDecoration: 'none', color: 'inherit' }}>Web Development</Link></h1>
                        <hr />
            ...
            <Container className="landing-container d-lg-none">
                <div className="flex-row">
                    <div className="flex-col content-col">
                        <h1 className='title text-center'><Link to="/website-development-solutions" style={{ textDecoration: 'none', color: 'inherit' }}>Web Development</Link></h1>
                        <hr />
