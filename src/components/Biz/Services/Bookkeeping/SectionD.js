...
import gusto from '../../../../assets/icons/icon-gusto-logo.png';
import quickbooks from '../../../../assets/icons/icon-quickbooks-logo.png';
import xero from '../../../../assets/icons/icon-xero-logo.png';
                ...
                {loadVideo && (
                    <a href="https://www.youtube.com/watch?v=HmbA_4g-iLc" target="_blank" rel="noopener noreferrer">
                        ...
                        <video width="960px" height="540px" className="img-fluid" autoPlay loop controls controlsList="nodownload">
                            <source src={require('../../../../assets/videos/video-runninng-a-business-stock.mp4')} type="video/mp4" />
                        </video>
                    </a>
                )}
            </div>
