...
import salesCollectionImage from '../../assets/Biz/images/img-sales-collection-stock.png';
import '../../assets/Biz/styles/SalesCollection.css';
            ...
            <Container className="landing-container my-3 d-none d-lg-block">
                <div className="flex-row">
                    <div className="flex-col image-col">
                        <Image src={salesCollectionImage} className='image-size-three' rounded alt="BizSolutions LLC Home Sales Collection Image" />
                    </div>
