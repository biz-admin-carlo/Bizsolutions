...
import landingBanner from '../../assets/Biz/images/img-app-landing-banner.png';
                ...
                <Container>
                    <div className="login-container">
                        ...
                        <div className="login-image">
                            <img className="img-fluid" src={landingBanner} alt="BizSolutions LLC Login Interface Image " />
                        </div>
                    </div>
                </Container>
            </div>
