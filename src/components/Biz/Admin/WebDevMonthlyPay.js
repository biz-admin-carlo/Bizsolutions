...
import BundleStarter from '../Pricing/WebDevelopment/Starter.js';
import BundleAdvanced from '../Pricing/WebDevelopment/Advanced.js';
import BundleExpert from '../Pricing/WebDevelopment/Expert.js';
import ProfessionalRevamp from '../Pricing/WebRevamp/Professional.js';
import EnterpriseRevamp from '../Pricing/WebRevamp/Enterprise.js';
            ...
            <div className='container'>
                <div className='row justify-content-around'>
                    ...
                    <div className='col-sm-12 col-md-4 mb-3'>
                        <BundleStarter selected={'monthly'} />
                    </div>

                    <div className='col-sm-12 col-md-4 mb-3'>
                        <BundleAdvanced selected={'monthly'} />
                    </div>
      ...
      <Container>
        ...
        <div className='container'>
            ...
            <div className='col-sm-12 col-md-6 mb-3'>
                <ProfessionalRevamp selected={'monthly'} />
            </div>

            <div className='col-sm-12 col-md-6 mb-3'>
                <EnterpriseRevamp selected={'monthly'} />
            </div>
